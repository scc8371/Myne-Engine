set libs= main.cpp src/App.cpp src/gl/SpriteBatch.cpp src/sound/SoundManager.cpp src/utils/Color.cpp src/utils/Font.cpp src/Game.cpp src/utils/Rectangle.cpp src/events/InputManager.cpp src/events/EventManager.cpp src/ResourceManager.cpp src/utils/Vector2.cpp src/stb.cpp src/gl/Shader.cpp src/texture/Texture.cpp src/texture/TextureManager.cpp src/gl/VAO.cpp src/gl/VBO.cpp src/utils/Circle.cpp glad.c
